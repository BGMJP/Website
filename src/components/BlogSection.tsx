  ...
  return (
    <>
      ...
      <section id="blog" className="py-32 sm:py-40 bg-gradient-to-br from-section via-white to-section/30 relative">
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <Button 
              ...
              onClick={() => window.open('https://topaz-dust-24726470.figma.site', '_blank')}
            >
              모든 아티클 보기
        ...
        {/* Section divider line */}
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-24 h-px bg-gradient-to-r from-transparent via-purple-300 to-transparent"></div>
      </section>
    </>
  );
}