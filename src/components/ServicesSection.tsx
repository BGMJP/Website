...
const serviceSteps: ServiceStep[] = [
  {
    ...
    stepNumber: "01.",
    title: "계정 & 브랜드 등록",
    description: "아마존 계정 가입, 브랜드 등록 등\n완벽한 아마존 입점 첫 단계 설계",
    icon: Users,
    modalContent: {
      title: "계정 & 브랜드 등록",
  ...
  },
  {
    ...
    stepNumber: "02.",
    title: "규제 & 승인 대응",
    description: "FDA 등 각종 수출 규제, 아마존 규정에\n안정적으로 대응",
    icon: Shield,
    modalContent: {
      title: "규제 & 승인 대응",
  ...
  },
  {
    ...
    stepNumber: "03.",
    title: "리스팅 기획 & 콘텐츠 제작",
    description: "전환율을 높이는 소비자 중심 리스팅 기획과\n매력적인 콘텐츠 제작",
    icon: PenTool,
    modalContent: {
      title: "리스팅 기획 & 콘텐츠 제작",
  ...
  },
  {
    ...
    stepNumber: "04.",
    title: "물류 & FBA 입고",
    description: "효율적인 비용 설계와 물류 최적화,\n안정적인 FBA 운영",
    icon: Truck,
    modalContent: {
      title: "물류 & FBA 입고",
  ...
  },
  {
    ...
    stepNumber: "05.",
    title: "광고 & 마케팅",
    description: "브랜드 성장을 위한 데이터 기반 광고와\n효과적인 외부 마케팅 전략",
    icon: Target,
    modalContent: {
      title: "광고 & 마케팅",
  ...
  },
  {
    ...
    stepNumber: "06.",
    title: "운영 & 리포트",
    description: "체계적인 CS 관리 및 운영 성과 리포트",
    icon: BarChart3,
    modalContent: {
      title: "운영 & 리포트",
...
function ServiceModalInternal({ 
  ...
  const handleImageClick = (imageUrl: string) => {
    // "운영 & 리포트"의 두 번째 이미지인 경우 iframe으로 열기
    if (service.modalContent.title === "운영 & 리포트" && currentImageIndex === 1) {
      setEnlargedImage({ 
  ...
  return (
    <DialogContent 
      className="!max-w-none !w-[98vw] !h-[92vh] !max-h-none overflow-hidden p-0 bg-white border-0 shadow-2xl"
      style={{
        width: '98vw',
        height: '92vh',
        maxWidth: 'none',
    ...
    >
      ...
      <div className="h-[calc(92vh-140px)] relative">
        <div className="p-0 h-full">
          ...
          {service.modalContent.title === "계정 & 브랜드 등록" ? (
            <>
              ...
              {service.modalContent.images.length > 1 && (
                <>
                  ...
                  {currentImageIndex === 0 && (
                    <button
                      onClick={nextImage}
                      className="absolute top-3 right-3 bg-[#FFB800] hover:bg-[#E5A500] text-[#1C3D5A] px-6 py-3 rounded-full transition-all duration-300 shadow-lg hover:scale-105 z-50 font-medium"
                    >
                      상표권 확보, 브랜드 권한의 시작 &gt;
                    </button>
                  )}
                  ...
                  {/* 페이지 카운터 - 아래로 이동 */}
                  <div className="absolute bottom-3 right-3 bg-[#1C3D5A]/90 text-white px-2 py-1 rounded-full text-xs font-semibold backdrop-blur-sm z-10">
              ...
              {currentImageIndex === 0 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/1-1.png")}>
                  ...
                  <img 
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/1-1.png")}
                  />
                </div>
              )}
              ...
              {currentImageIndex === 1 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/1-2.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                      <span className="text-white text-sm font-medium">클릭하여 확대</span>
                    </div>
                  ...
                  <img 
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/1-2.png")}
                  />
                </div>
              )}
            </>
            ...
            <div className="w-full h-full relative flex items-center justify-center">
              {/* 호버 오버레이 */}
              <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/2.png")}>
                <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                  <ZoomIn className="w-10 h-10 text-white" />
                  <span className="text-white text-sm font-medium">클릭하여 확대</span>
                </div>
              ...
              <img 
                src="https://hs3056.github.io/servicesection1/2.png"
                alt="규제 & 승인 대응"
                className="max-w-full max-h-full object-contain cursor-pointer"
                style={{
                  imageRendering: 'crisp-edges',
                ...
                loading="lazy"
                onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/2.png")}
              />
            </div>
          ) : service.modalContent.title === "물류 & FBA 입고" ? (
            // "물류 & FBA 입고" 모달 - 이미지로 교체
            <div className="w-full h-full relative flex items-center justify-center">
              {/* 호버 오버레이 */}
              <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/4.png")}>
                <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                  <ZoomIn className="w-10 h-10 text-white" />
                  <span className="text-white text-sm font-medium">클릭하여 확대</span>
                </div>
              ...
              <img 
                src="https://hs3056.github.io/servicesection1/4.png"
                alt="물류 & FBA 입고"
                className="max-w-full max-h-full object-contain cursor-pointer"
                style={{
                  imageRendering: 'crisp-edges',
                ...
                loading="lazy"
                onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/4.png")}
              />
            </div>
            ...
            <>
              ...
              {currentImageIndex === 0 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/3-1.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                      <span className="text-white text-sm font-medium">클릭하여 확대</span>
                    </div>
                  ...
                  <img 
                    src="https://hs3056.github.io/servicesection1/3-1.png"
                    alt="리스팅 기획 & 콘텐츠 제작 슬라이드 1"
                    className="max-w-full max-h-full object-contain cursor-pointer"
                    style={{
                      imageRendering: 'crisp-edges',
                      willChange: 'transform',
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/3-1.png")}
                  />
                </div>
              )}
              ...
              {currentImageIndex === 1 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/3-2.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                      <span className="text-white text-sm font-medium">클릭하여 확대</span>
                    </div>
                  ...
                  <img 
                    src="https://hs3056.github.io/servicesection1/3-2.png"
                    alt="리스팅 기획 & 콘텐츠 제작 슬라이드 2"
                    className="max-w-full max-h-full object-contain cursor-pointer"
                    style={{
                      imageRendering: 'crisp-edges',
                      willChange: 'transform',
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/3-2.png")}
                  />
                </div>
              )}
            </>
            ...
            <>
              ...
              {currentImageIndex === 0 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/6-1.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                      <span className="text-white text-sm font-medium">클릭하여 확대</span>
                    </div>
                  ...
                  <img 
                    src="https://hs3056.github.io/servicesection1/6-1.png"
                    alt="운영 & 리포트 슬라이드 1"
                    className="max-w-full max-h-full object-contain cursor-pointer"
                    style={{
                      imageRendering: 'crisp-edges',
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/6-1.png")}
                  />
                </div>
              )}
              ...
              {currentImageIndex === 1 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/6-2.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                  ...
                  <img 
                    src="https://hs3056.github.io/servicesection1/6-2.png"
                    alt="운영 & 리포트 슬라이드 2"
                    className="max-w-full max-h-full object-contain cursor-pointer"
                    style={{
                      imageRendering: 'crisp-edges',
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/6-2.png")}
                  />
                </div>
              )}
            </>
            ...
            <>
              ...
              {currentImageIndex === 0 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/5-1.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                      <span className="text-white text-sm font-medium">클릭하여 확대</span>
                    </div>
                  ...
                  <img 
                    src="https://hs3056.github.io/servicesection1/5-1.png"
                    alt="광고 & 마케팅 슬라이드 1"
                    className="max-w-full max-h-full object-contain cursor-pointer"
                    style={{
                      imageRendering: 'crisp-edges',
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/5-1.png")}
                  />
                </div>
              )}
              ...
              {currentImageIndex === 1 && (
                <div className="w-full h-full relative flex items-center justify-center">
                  {/* 호버 오버레이 */}
                  <div className="absolute inset-x-36 inset-y-0 bg-black/0 hover:bg-black/60 transition-all duration-300 flex items-center justify-center z-20 pointer-events-auto group cursor-pointer" onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/5-2.png")}>
                    <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center gap-2">
                      <ZoomIn className="w-10 h-10 text-white" />
                      <span className="text-white text-sm font-medium">클릭하여 확대</span>
                    </div>
                  ...
                  <img 
                    src="https://hs3056.github.io/servicesection1/5-2.png"
                    alt="광고 & 마케팅 슬라이드 2"
                    className="max-w-full max-h-full object-contain cursor-pointer"
                    style={{
                      imageRendering: 'crisp-edges',
                    ...
                    loading="lazy"
                    onClick={() => handleImageClick("https://hs3056.github.io/servicesection1/5-2.png")}
                  />
                </div>
              )}
            </>
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="relative w-full flex-1 rounded-xl overflow-hidden bg-gray-50 shadow-lg group flex items-center justify-center">
                    ...
                    <motion.img 
                      ...
                      className="max-w-full max-h-full object-contain cursor-pointer transition-transform duration-300 group-hover:scale-105 relative z-10"
                      style={{
                        imageRendering: 'crisp-edges',
                        willChange: 'transform',
                        width: 'auto',
                    ...
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-300 flex items-center justify-center z-20 pointer-events-none">
                      <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 bg-white/95 rounded-full p-3 flex flex-col items-center gap-2 shadow-lg">
                        ...
                        {/* "운영 & ���포트"의 첫 번째 이미지인 경우 "자세히 보기" 텍스트 표시 */}
                    ...
                    {service.modalContent.images.length > 1 && (
                      <>
                        ...
                        {/* 이미지 카운터 - 아래로 이동 */}
                        <div className="absolute bottom-3 right-3 bg-[#1C3D5A]/90 text-white px-2 py-1 rounded-full text-xs font-semibold backdrop-blur-sm">
                          {currentImageIndex + 1} / {service.modalContent.images.length}
                        </div>
                      </>
                    )}
                          ...
                          <div className="w-1/2 h-full pb-[60px] p-4 flex items-center justify-center">
                            <div className="w-full h-full">
                              <img 
                                ...
                                onClick={() => handleImageClick("https://live.staticflickr.com/65535/54797471183_ff8c215ec2_b.jpg")}
                              />
                            </div>
                          </div>
                        </div>
      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        >
          ...
          <div className="hidden lg:block">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  {[
                    { step: 1, title: "아마존 계정,가상 계좌 생성", phase: "입점", weeks: [1] },
                    { step: 2, title: "카테고리 승인,상표권 출원", phase: "입점", weeks: [2, 3] },
                    { step: 3, title: "리스팅 기획 및 키워드 추출", phase: "입점", weeks: [3, 4] },
                    { step: 4, title: "물류 업체 알선 및 배송", phase: "입점", weeks: [5, 6, 7] },
                    { step: 5, title: "리스팅 이미지, A+ 콘텐츠 제작", phase: "입점", weeks: [5, 6, 7] },
                    { step: 6, title: "브랜드 페이지 제작", phase: "입점", weeks: [8] },
                    { step: 7, title: "광고 캠페인 생성 및 관리", phase: "입점", weeks: [9] },
                    { step: 8, title: "재고 및 CS 관리", phase: "입점", weeks: [9] },
                    { step: 9, title: "종합 보고서 작성", phase: "입점", weeks: [9] }
                  ].map((item, index) => (
                    <motion.div
                      key={item.step}
          ...
          <div className="lg:hidden space-y-4">
            {[
              { step: 1, title: "아마존 계정,가상 계좌 생성", phase: "입점" },
              { step: 2, title: "카테고리 승인,상표권 출원", phase: "입점" },
              { step: 3, title: "리스팅 기획 및 키워드 추출", phase: "입점" },
              { step: 4, title: "물류 업체 알선 및 배송", phase: "입점" },
              { step: 5, title: "리스팅 이미지, A+ 콘텐츠 제작", phase: "입점" },
              { step: 6, title: "브랜드 페이지 제작", phase: "입점" },
              { step: 7, title: "광고 캠페인 생성 및 관리", phase: "입점" },
              { step: 8, title: "재고 및 CS 관리", phase: "입점" },
              { step: 9, title: "종합 보고서 작성", phase: "입점" }
            ].map((item, index) => (
              <motion.div
                key={item.step}
                  ...
                  >
                    ...
                    <CardContent className="p-6 lg:p-8 relative z-10 h-full flex flex-col">
                      ...
                      <div className="flex-1 flex flex-col">
                        ...
                        <p className="text-[#868E96] leading-relaxed mb-6 lg:mb-8 text-base lg:text-lg flex-1 whitespace-pre-line">
                          {service.description}
                        </p>
                      </div>
