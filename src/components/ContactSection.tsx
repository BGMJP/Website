      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <Card className="border-none shadow-lg bg-white overflow-hidden">
            <CardHeader className="pb-6">
              <CardTitle className="text-2xl font-black text-[#1C3D5A] text-center flex items-center justify-center gap-3">
                <MapPin className="h-6 w-6 text-[#1C3D5A]" />
                찾아오시는 길
              </CardTitle>
              <CardDescription className="text-[#868E96] text-center leading-relaxed">
                서울특별시 금천구 가산디지털1로 204, 904호
              </CardDescription>
            </CardHeader>
