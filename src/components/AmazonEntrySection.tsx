      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            AI 데이터와 전문가의 인사이트로 무료 시장 조사를 받아보세요.
          </motion.p>
        </motion.div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center max-w-4xl mx-auto">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <span className="relative z-10">AI 무료 시장 조사 신청하기</span>
                  <motion.div
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                    >
                      <span className="relative z-10">AI 시장 조사 샘플 확인하기</span>
                      <motion.div
                        className="relative z-10"
                        animate={{ x: [0, 4, 0] }}
                        transition={{ duration: 1.5, repeat: Infinity }}
                  ...
                  <DialogContent className="!max-w-none !w-[95vw] !h-[90vh] !max-h-none overflow-hidden p-0 bg-white border-0 shadow-2xl">
                    ...
                    <div className="h-[calc(90vh-140px)] relative">
                      <iframe 
                        src="https://hs3056.github.io/researchsample/"
